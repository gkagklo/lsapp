...
<div class="well">
 ...
 <center><p style="font-size:18px"> Τα πεδια με (<span class="kok">  * </span>) είναι υπωχρεωτικά. </p></center><br>
  {!! Form::open(['action' => 'TabletController@store','method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
  ...
  <div class="form-row">
      <div class="form-group col-md-6"> 
          ...
          {{ Form::select('system', ['Android' => 'Android' , 'Apple iOS' => 'Apple iOS' , 'Windows' => 'Windows'],  null,['class' => 'form-control','placeholder' => ''])}}
          </div>
